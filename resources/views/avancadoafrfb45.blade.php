...
@section('content')
    ...
    <section id="rf" style=" padding: 50px">
        <div class="container">
            ...
            <h2 class="mb-5 text-center">Edital Direcionado AFRFB Avançado - CICLO 45h</h2>
    ...
    <section>
        <div class="container" style="text-align: center; padding: 50px 0">
            ...
            <h2 class="mb-5" style="font-weight: normal; font-family: 'Open Sans', sans-serif">Acesso Imediato por apenas <span style="font-weight: bold; color: #5884B5">R$ 499,90 à vista</span> ou em até <span style="font-weight: bold; color: #5884B5">6 vezes</span></h2>
            ...
            <div class="container mt-5">
                <div class="card-deck mb-3 text-center" style="width: 50rem; margin: 0 auto; padding: 0;">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">R$499,90</h1>
                            <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <a href="https://pay.hotmart.com/S9568923O" class="btn btn-lg btn-block btn-primary" style="color: #fff">Quero começar</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section style="background-color: #3F4755">
        <div class="container" style="text-align: center; padding: 50px 0">
            <h2 style="font-family: 'Open Sans', sans-serif; font-weight: bold; text-align: center">
                <b style="color: #fff">Ainda não tem certeza? Não se preocupe.</b> <br>
                <span style="color:#ffe6a3">VOCÊ TEM 15 DIAS DE GARANTIA INCONDICIONAL!</span>
                <br>
                <span style="color:#47c8cc;font-size:18px">- SUA SATISFAÇÃO GARANTIDA OU SEU DINHEIRO DE VOLTA -</span>
            </h2>

            <img src="img/15_dias.jpg" alt="">
