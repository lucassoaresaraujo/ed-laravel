...
@section('content')
    ...
    <section>
        <div class="container" style="text-align: center; padding: 50px 0">
            ...
            <h2 class="mb-5" style="font-weight: normal; font-family: 'Open Sans', sans-serif">Acesso Imediato por apenas <span style="font-weight: bold; color: #5884B5">R$ 349,30 à vista</span> ou em até <span style="font-weight: bold; color: #5884B5">6 vezes</span></h2>
            ...
            <div class="container mt-5">
                <div class="card-deck mb-3 text-center" style="width: 50rem; margin: 0 auto; padding: 0;">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">R$349,30</h1>
                            <ul class="list-unstyled mt-3 mb-4">
